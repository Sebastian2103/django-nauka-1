...
from .forms import EmailPostsForm, CommentForm, SearchForm
...
def post_list(request, tag_slug=None):
    ...
    try:
        ...
        # Jesli pagenumber nie jest liczba całkowita zwróc pierwsza stronę
        posts = paginator.page(1)
    except EmptyPage:
        # Jesli zmienna pagenumbe jest poza zakresem wyslij ostatnia strone projektów
...
def post_comment(request, post_id):
    ...
    if form.is_valid():
        #utworz obiekt Comment bez zapsywania go w bazie danych
